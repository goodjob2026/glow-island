// dialog-data.js — all 12 dialog sequences (6 chapters × intro + outro)
...
export const DIALOGS = {
  ...
  ch6_intro: [
    { speaker: "ひなた", text: "灯塔……是爷爷最放不下的地方。他说，灯塔亮着，他就觉得岛还活着。" },
    { speaker: "律", text: "那我们就把它点亮。" },
    { speaker: "ひなた", text: "（她看了我很久。）你说这句话，好像很认真。" },
    { speaker: "律", text: "我是认真的。" }
  ],
  ch6_outro: [
